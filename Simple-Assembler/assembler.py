...
#         l = line.split(" ")
#         if l[0] in O_A.keys():
#             print(convert_OA(l[0]))
#             print(convert_OA(l[1]))
#             print(convert_OA(l[2]))
#             l[3] = l[3].replace("\n", "")
#             print(convert_OA(l[3]))
#             print("\n")
#         elif l[0] in O_B.keys() and l[2][0] == '$':
#             print(convert_OB(l[0]))
#             print(convert_OB(l[1]))
#             print(convert_OB(l[2]))
#             print("\n")
#         elif l[0] in O_C.keys():
#             print(convert_OC(l[0]))
#             print(convert_OC(l[1]))
#             l[2] = l[2].replace("\n", "")
#             print(convert_OC(l[2]))
#             print("\n")
#         elif l[0] in O_D.keys():
#             print(convert_OD(l[0]))
#             print(convert_OD(l[1]))
#             l[2] = l[2].replace("\n", "")
#             print(convert_OD(l[2]))
#             print("\n")
...
#     global counter, f2
#     if len(k) != 2:
#         print(f"Error in Line {counter}: {k[0]} must contain 1 parameters\n")
#         return 1
#     return 0
...
#     global counter, f2
#     if (len(k) != 1):
#         print(f"Error in Line {counter}: {k[0]} must contain no parameters\n")
#         return 1
#     return 0
...
#             print(f"Error on line {counter}:No Label/variable name {k[1]}\n")
#             return 1
#     else:
...
#             print(f"Error in Line {counter}: Variables must be declared at the very beginning\n")
#             l_result.append(1)
...
#     else:
#         counter += 1
#         print(f"Error in Line {counter}: Invalid operand\n")
#         l_result.append(1)
...
#     global f2,a
#     if 'hlt' not in l_cmd:
#         print("Error: No hlt instruction present\n")
#         a.append(1)
        

#     elif 'hlt' != l_cmd[-1]:
#         print("Cant execute command after halt\n")
#         a.append(1)    
#         exit()
